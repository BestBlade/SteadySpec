...
SteadySpec 包含反漂移方法、实验性的 v0.7 Assurance Protocol Candidate，
以及 legacy 五动词软件技能包。采用前读 [SCOPE.md](SCOPE.md)。
...
可选 legacy projection，可显式加入两个 extension case：
...
这是进阶 legacy recipe，不是 v0.7 protocol，也不是首次使用的必经路径。
